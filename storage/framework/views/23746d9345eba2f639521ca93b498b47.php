...
<body class="float-container shadow-lg" style="background-color: #1a1a1a;">
    ...
    <div class="text-center">
        <a href="<?php echo e(route('design')); ?>" class="btn btn-outline-light 
        ">Back to Cube</a>
    </div>
...
<body class="d-flex flex-column justify-content-center align-items-center vh-100" style="background-color: #000000;">
    <div class="text-center">
        ...
        <a href="<?php echo e(route('things')); ?>" class="btn btn-outline-light">
            Back to Cube
        </a>
    </div>
</body>
</html> -->
<?php /**PATH C:\Users\User\Documents\lone\resources\views/goals.blade.php ENDPATH**/ ?>